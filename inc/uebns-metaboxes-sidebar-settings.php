...
function uebns_settings_display() {
	...
	if ( ! $settings['_uebns_layout'] ) {
		$settings['_uebns_layout'] = 'default'; }

	$settings['_uebns_photo_setting'] = get_post_meta( $post->ID, '_uebns_photo_setting', true );
	if ( ! $settings['_uebns_photo_setting'] ) {
		$settings['_uebns_photo_setting'] = 'round'; }

	$settings['_uebns_color_shema'] = get_post_meta( $post->ID, '_uebns_color_shema', true );
	if ( ! $settings['_uebns_color_shema'] ) {
		$settings['_uebns_color_shema'] = '#eb5466'; }
	...
	if ( ! $settings['_uebns_line_member'] ) {
		$settings['_uebns_line_member'] = '1'; }
	...
	if ( ! $settings['_uebns_filter_image'] ) {
		$settings['_uebns_filter_image'] = 'none'; }
	...
	if ( ! $settings['_uebns_images_clickable'] ) {
		$settings['_uebns_images_clickable'] = 'no'; }
