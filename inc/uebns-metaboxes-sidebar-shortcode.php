...
function uebns_add_shortcode_panel() {
	add_meta_box( 
		'uebns_shortcode', 
		'<span class="dashicons dashicons-admin-links"></span> '.__('Shortcode', 'ueber-uns'), 
		...
		<div class="layout_settings">
			...
			<div class="layout_out">
				<?php 
					...
					$shortcode_unpublished = "<span style='display:inline-block;color:#e17055'>" . __("<strong>Publish</strong> your team before you can see you shortcode here!", 'ueber-uns' ) . "</span>";
					echo ($slug != '') ? $shortcode : $shortcode_unpublished;
				?>
				<p>
					<?php _e('To display your team members on your site, copy-paste the <strong>[uebns-shortcode]</strong> above in your post/page.', 'ueber-uns' ) ?>
				</p>
			</div>
		</div>
	</div>
