...
A very simple "About Us" Site Plugin. Create Teams and copy-paste the shortcode everywhere in your post or site. 
...
1. Upload `ueber-uns-team` to the `/wp-content/plugins/` directory
