...
require_once( 'inc/uebns-metaboxes-settings-teams.php' );
require_once( 'inc/uebns-metaboxes-teams-content.php' );
...
function uebns_load_plugin_textdomain() {
	load_plugin_textdomain( 'aus', '', 'about-us-shortcode/lang/' );
}
